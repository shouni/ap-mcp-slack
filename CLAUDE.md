...
- [slack-go/slack](https://github.com/slack-go/slack) — Slack Web API client (chat.postMessage / chat.delete / conversations.list / users.conversations / search.messages / users.list / users.lookupByEmail)
